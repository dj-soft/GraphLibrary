        ...
        private class ItemInfo
        {
            ...
            public ItemInfo(WinForm.Control control, string key, int level, Point origin)
            {
                ...
                else
                {
                    ...
                    IsVisible = YN(control.IsVisibleInternal());
            ...
            public readonly string IsVisible;
            ...
            private static string[] _GetMapTitles()
            {
                string[] titles = new string[]
                {
                    ...
                    nameof(Key), nameof(Type), nameof(ItemIndex), nameof(Name), nameof(Text), nameof(Dock), nameof(Bounds), nameof(AbsoluteBounds), nameof(ClientRectangle), 
                    nameof(Visible), nameof(IsVisible), nameof(Enabled)
                };
                return titles;
            }
            /// <summary>
            ...
            private string[] _GetMapValues()
            {
                string[] values = new string[]
                {
                    ...
                    Key, Type, ItemIndex, Name, Text, Dock, Bounds, AbsoluteBounds, ClientRectangle, 
