...
namespace Asol.Tools.WorkScheduler.ComponentsOld.Grid
{
    ...
    public class GTable : InteractiveContainer, IInteractiveItem, IDisposable
    {
        ...
        /// </summary>
        public GGrid GGrid { get { return this._Grid; } }
        private GGrid _Grid;
        /// <summary>
        /// Data table
        /// </summary>
        public DTable DataTable { get { return this._Table; } }
        private DTable _Table;
        /// <summary>
        ...
        /// Table position
        /// </summary>
        internal GridPositionItem TablePosition { get { return this._TablePosition; } set { this._TablePosition = value; } }
        private GridPositionItem _TablePosition;
        /// <summary>
        /// Columns in GTable
        /// </summary>
        internal GColumnSet ColumnSet { get { return this._ColumnSet; } }
        private GColumnSet _ColumnSet;
        /// <summary>
        /// Rows in GTable
        /// </summary>
        internal GRowSet RowSet { get { return this._RowSet; } }
        private GRowSet _RowSet;
        /// <summary>
        ...
        {
            this.SetTablePositions(this.Bounds, ProcessAction.PrepareInnerItems, EventSourceType.BoundsChange | EventSourceType.ApplicationCode, false);
        }
        /// <summary>
        ...
        {
            GridPositionItem position = this.TablePosition;
            // All bounds (for _ColumnSet and _RowSet) are relative to this = GTable, because they are Child items od GTable (Sets are not Child items of GGrid!  Because the GTable is Child item of GGrid)
            int split = position.Split;

            Rectangle columnsBounds = new Rectangle(0, 0, newBounds.Width, split);
            if (columnsBounds != this._ColumnSet.Bounds)
                this._ColumnSet.SetBounds(columnsBounds, actions, eventSource);
            else
                this._ColumnSet.RefreshPositions();

            Rectangle rowsBounds = new Rectangle(0, split, newBounds.Width, newBounds.Height - split);
            if (rowsBounds != this._RowSet.Bounds)
                this._RowSet.SetBounds(rowsBounds, actions, eventSource);
            else
        ...
        protected void ChildArrayReload()
        {
            ...
            this.ChildList.Add(this.ColumnSet.ColumnSetSplitter);              // Add as last item => HorizontalSplitter between ColumnSet and RowSet
    ...
    public class GColumnSet : InteractiveContainer, IEnumerable<GColumn>
    {
        ...
        /// </summary>
        public GTable GTable { get { return this._Table; } }
        ...
        /// </summary>
        public Rectangle BoundsDataColumns { get { return this._BoundsDataColumns; } }
        Rectangle _BoundsDataColumns;
        #endregion
        #region TimeAxis
        /// <summary>
    ...
    public class GColumn : InteractiveContainer
    {
        ...
        /// </summary>
        internal DColumn DataColumn { get { return this._DataColumn; } }
        private DColumn _DataColumn;
        /// <summary>
        ...
        /// </summary>
        internal int ColumnID { get { return this._ColumnID; } }
        ...
        /// </summary>
        internal DTableSortRowType SortType { get { return this._SortType; } set { this._SortType = value; } }
        private DTableSortRowType _SortType = DTableSortRowType.None;
        #endregion
        #region BoundsChange
        /// <summary>
    ...
    public class GColumnHeader : InteractiveDragObject, IInteractiveItem
    {
        ...
        /// </summary>
        internal GColumn GColumn { get { return this._Column; } }
        private GColumn _Column;
        /// <summary>
        /// Data for this column
        /// </summary>
    ...
    public class GRowSet : InteractiveContainer, IEnumerable<GRow>
    {
        ...
        /// </summary>
        public int RowSizeDefault { get { return this._SizeDefault; } set { this._SizeDefault = (value < 10 ? 10 : value); } }
        ...
        /// </summary>
        public int VisualOffset { get { return this._VisualOffset; } set { this._VisualOffset = (value < 0 ? 0 : value); this.InvalidatePositions(); } }
    ...
    public class GRow : InteractiveContainer
    {
        ...
        /// Owner RowSet
        /// </summary>
        internal GRowSet GRowSet { get { return this._RowSet; } }
        private GRowSet _RowSet;
        /// <summary>
        /// Data for this column
        /// </summary>
        internal DRow DataRow { get { return this._DataRow; } }
        private DRow _DataRow;
        /// <summary>
        /// Owner table of this GRowSet
        /// </summary>
        ...
        /// </summary>
        public override bool IsVisible { get { return this._IsVisible; } set { this.InvalidateVisualList(); this._IsVisible = value; } }
        private bool _IsVisible;
        /// <summary>
        /// Order of item, can be changed
        /// </summary>
        public int Order { get { this.CheckRowValid(); return this._Order; } set { this.InvalidateOrder(); this._Order = (value < 0 ? 0 : value); } }
        private int _Order;
        /// <summary>
        /// Order of item, can be changed.
        ...
        /// </summary>
        public int Size { get { this.CheckRowValid(); return this._SizeValid; } set { this.InvalidatePositions(); this._SizeN = (value < 0 ? 0 : value); } }
        private int _SizeValid;
        /// <summary>
        /// SizeN: Width for Column item, or Height for Table item. Can contain a null value.
        /// </summary>
        public int? SizeN { get { return this._SizeN; } set { this.InvalidatePositions(); this._SizeN = value; } }
        private int? _SizeN;
        /// <summary>
        ...
        /// </summary>
        public int BeginLogical { get { this.CheckRowValid(); return this._BeginLogical; } }
        ...
        /// </summary>
        public int EndLogical { get { this.CheckRowValid(); return this._EndLogical; } }
        ...
        /// </summary>
        public int BeginVisual { get { this.CheckRowValid(); return this._BeginVisual; } }
        private int _BeginVisual;
        /// <summary>
        /// End in logical values. First item has End = SizeVisible, second item has End = BeginLogical + SizeVisible, and so on.
        /// </summary>
        public int EndVisual { get { this.CheckRowValid(); return this._EndVisual; } set { this._EndVisualSet(value); } }
        ...
        internal bool RowIsSelected { get { return this._RowIsSelected; } }
        private bool _RowIsSelected;
        /// <summary>
    ...
    public class GRowHeader : InteractiveDragObject, IInteractiveItem
    {
        ...
        /// Owner Row
        /// </summary>
        internal GRow GRow { get { return this._GRow; } }
        private GRow _GRow;
        /// <summary>
        /// Owner RowSet
        /// </summary>
