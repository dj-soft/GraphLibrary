...
namespace Djs.Common.Components.Grid.Out
{
        ...
        where T : IGridPositionItem, IDataPersistent, new()
    {
        ...
        /// </summary>
        public int SizeDefault { get { return this._SizeDefault; } } private int _SizeDefault;
        /// <summary>
        /// GridPositionItem for header item
        /// </summary>
        public T ItemHeader { get { return this._ItemHeader; } } private T _ItemHeader;
        /// <summary>
        /// Size of header item
        /// </summary>
        ...
        /// </summary>
        public int VisualOffset { get { return this._VisualOffset; } set { this._VisualOffset = (value < 0 ? 0 : value); this.Invalidate(); } } private int _VisualOffset;
        /// <summary>
        ...
        /// User class can store this ID as "hash" after recalculate its private values, and check this "hash" in its equivalent "CheckValid()" proecss.
        /// </summary>
        public string IdentityKey { get { this.CheckValid(); return this._IdentityKey; } } private string _IdentityKey;
        #endregion
        ...
        /// </summary>
        protected bool IsValid { get { return this._IsValid; } } private bool _IsValid;
    ...
    {
        public TimeRange TimeRange { get { return this._TimeRange; } set { this._TimeRange = value; } } private TimeRange _TimeRange;
    }
    /// <summary>
    ...
    public class GridPositionItem : IDataPersistent, IGridPositionItem
    {
        ...
        /// </summary>
        public IGridPositionSet Owner { get { return this._Owner; } set { this._Owner = value; this.Invalidate(); } } private IGridPositionSet _Owner;
        /// <summary>
        /// ID of item, a constant value
        /// </summary>
        public int ItemId { get { return this._ItemId; } set { this.Invalidate(); this._ItemId = (value < 0 ? 0 : value); } } private int _ItemId;
        /// <summary>
        /// True for Visible item, false for Invisible
        /// </summary>
        public bool IsVisible { get { return this._IsVisible; } set { this.Invalidate(); this._IsVisible = value; } } private bool _IsVisible;
        /// <summary>
        /// Order of item, can be changed
        /// </summary>
        public int Order { get { this.CheckValid(); return this._Order; } set { this.Invalidate(); this._Order = (value < 0 ? 0 : value); } } private int _Order;
        /// <summary>
        ...
        /// </summary>
        public int Size { get { this.CheckValid(); return this._SizeValid; } set { this.Invalidate(); this._SizeN = (value < 0 ? 0 : value); } } private int _SizeValid;
        /// <summary>
        /// SizeN: Width for Column item, or Height for Table item. Can contain a null value.
        /// </summary>
        public int? SizeN { get { return this._SizeN; } set { this.Invalidate(); this._SizeN = value; } } private int? _SizeN;
        /// <summary>
        ...
        /// </summary>
        public int Split { get { return (this._SplitN.HasValue ? this._SplitN.Value : 40); } set { this.Invalidate(); this._SplitN = (value < 0 ? 0 : value); } } private int? _SplitN;
        /// <summary>
        ...
        /// </summary>
        public int BeginLogical { get { this.CheckValid(); return this._BeginLogical; } } private int _BeginLogical;
        /// <summary>
        ...
        /// </summary>
        public int EndLogical { get { this.CheckValid(); return this._EndLogical; } } private int _EndLogical;
        /// <summary>
        /// Begin in visual values. First item has Begin = VisualOffset, second item has Begin = Prev.EndVisual, and so on.
        /// </summary>
        public int BeginVisual { get { this.CheckValid(); return this._BeginVisual; } } private int _BeginVisual;
        /// <summary>
        ...
        /// End in logical values. First item has End = SizeVisible, second item has End = BeginLogical + SizeVisible, and so on.
        /// </summary>
        public int EndVisual { get { this.CheckValid(); return this._EndVisual; } set { this._EndVisualSet(value); } } private int _EndVisual;
