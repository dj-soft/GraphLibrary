...
namespace DjSoft.App.iCollect.Application
{
    ...
    /// <code>
    /// // Root složka aplikačních dat:
    /// var folder = WinRegFolder.CreateForProcessView(RegistryHive.CurrentUser, "Software\\Company\\ApplicationName\\Config");
    /// 
    /// // Jednotlivě:
    /// WinReg.WriteInt32(folder, "StoredValue1", 42);
    /// var value = WinReg.ReadInt32(folder, "StoredValue1");
    /// 
    /// // Hromadně:
    /// using (var key = WinReg.OpenKey(folder, false))
    /// {
    ///     var value1 = WinReg.ReadInt32(key, "StoredValue1");
    ///     var value2 = WinReg.ReadInt32(key, "StoredValue2");
    ///     var value3 = WinReg.ReadInt32(key, "StoredValue3");
    ///     var value4 = WinReg.ReadString(key, "StoredValue4");
    /// }
    /// </code>
    /// </summary>
    public class WinReg
    {
        ...
        /// </summary>
        public static WinRegFolder CurrentFolder { get { return __CurrentFolder; } set { __CurrentFolder = value; } }
        private static WinRegFolder __CurrentFolder;
        #endregion
        ...
        /// Načte řetězec z Windows registru
        /// </summary>
        /// <param name="register">Otevřený klíč registru</param>
        /// <param name="keyName">Název klíče, musí být zadán</param>
        /// <returns>Nalezený string / Default hodnota (null)</returns>
        ...
        /// Privátní VÝKONNÁ metoda.
        /// </summary>
        /// <param name="regKey">Otevřený klíč registru</param>
        /// <param name="subKeyName">Jméno podsložky, kterou budeme mazat</param>
    ...
    public struct WinRegFolder
    {
        ...
        /// </summary>
        public RegistryHive Hive { get { return this._Hive; } }
        ...
        /// </summary>
        public RegistryView View { get { return this._View; } }
        ...
        /// </summary>
        public bool IsEmpty { get { return !this._HasData; } }
        ...
        /// <summary>
        /// Ověří správnost zadaného názvu klíče this.Folder.
        /// </summary>
