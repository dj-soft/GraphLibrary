...
namespace DjSoft.App.iCollect.Data.XmlSerializer
{
    using DjSoft.App.iCollect.Data.XmlSerializer.Internal;
...
namespace DjSoft.App.iCollect.Data.XmlSerializer.Internal
{
    /// <summary>
    ...
    internal sealed class XmlPersist : IDisposable
    {
        ...
        internal class XmlPersistVBase
        {
            ...
            {
                string name = TypeLibrary.CreateXmlName(elementName);
    ...
    internal class TypeLibrary : IDisposable
    {
        ...
        internal class PropInfo
        {
            ...
            private static string _GetPropertyXmlName(PropertyInfo property)
            {
                ...
                return TypeLibrary.CreateXmlName(xmlName);
            }
            /// <summary>
            /// Konstrutor
            /// </summary>
